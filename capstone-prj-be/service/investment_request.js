...
const borrow_request = require('./borrow_request');
...
const handle_after_create_success = async (user, Borrow_request, invest_request, account_information, min_invest_money, t) => {
   ...
   const borrow_content = "your borrow request has invested " + invest_request.account
   ...
   await NotificationService.create_notification(user.id, NOTIFICATION_TYPE.BORROW_REQUEST, ACCOUNT_TYPE.BORROWER, borrow_content, 0, Borrow_request.id)
}

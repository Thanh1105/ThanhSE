                        ...
                        <div className="col-9">
                                ...
                                <div className="lending-detail">
                                    ...
                                    <div className="container align-items-center justify-content-center d-flex">
                                        ...
                                        <div className="col-6 text-center">
                                            <p className="">
                                                {currency.format(
                                                    data?.minimum_money_for_start || ""
                                                )}
                                            </p>
                                            <p className="text_primary">VND</p>
                                        </div>
                                    </div>
                                    <hr className="dropdown-divider" />
                            ...
                            {data &&
                                <div className="col-12 d-flex justify-content-around">
                                    <ButtonDetail title={'Star Now'} api={api_start} id={data.id} />
                                    <ButtonDetail title={'Cancel'} api={api_cancel} id={data.id} />
                                </div>
                            }

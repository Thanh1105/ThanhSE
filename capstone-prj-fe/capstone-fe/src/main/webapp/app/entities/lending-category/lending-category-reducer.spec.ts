...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_LENDINGCATEGORY_LIST actions', async () => {
    ...
    it('dispatches FETCH_LENDINGCATEGORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_LENDINGCATEGORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_LENDINGCATEGORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_LENDINGCATEGORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_LENDINGCATEGORY actions', async () => {
      const expectedActions = [
        {

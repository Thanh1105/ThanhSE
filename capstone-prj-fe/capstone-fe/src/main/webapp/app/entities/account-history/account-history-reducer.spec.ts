...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ACCOUNTHISTORY_LIST actions', async () => {
    ...
    it('dispatches FETCH_ACCOUNTHISTORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ACCOUNTHISTORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ACCOUNTHISTORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ACCOUNTHISTORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ACCOUNTHISTORY actions', async () => {
      const expectedActions = [
        {

    ...
    <Row>
      <Col md="8">
        <h2 data-cy="notificationTokenDetailsHeading">
          <Translate contentKey="capstoneFeApp.notificationToken.detail.title">NotificationToken</Translate>
        </h2>
        <dl className="jh-entity-details">
          ...
          <dd>{notificationTokenEntity.accounts ? notificationTokenEntity.accounts.id : ''}</dd>
        </dl>

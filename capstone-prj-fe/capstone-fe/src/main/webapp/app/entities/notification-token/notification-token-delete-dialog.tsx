...
export const NotificationTokenDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="capstoneFeApp.notificationToken.delete.question">
        <Translate contentKey="capstoneFeApp.notificationToken.delete.question" interpolate={{ id: notificationTokenEntity.id }}>
      ...
      <ModalFooter>
        ...
        <Button id="jhi-confirm-delete-notificationToken" data-cy="entityConfirmDeleteButton" color="danger" onClick={confirmDelete}>

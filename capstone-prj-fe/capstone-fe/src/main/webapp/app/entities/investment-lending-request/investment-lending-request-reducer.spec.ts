...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './investment-lending-request.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_INVESTMENTLENDINGREQUEST_LIST actions', async () => {
    ...
    it('dispatches FETCH_INVESTMENTLENDINGREQUEST actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_INVESTMENTLENDINGREQUEST actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_INVESTMENTLENDINGREQUEST actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_INVESTMENTLENDINGREQUEST actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_INVESTMENTLENDINGREQUEST actions', async () => {
      const expectedActions = [
        {

...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_LENDINGREQUEST_LIST actions', async () => {
    ...
    it('dispatches FETCH_LENDINGREQUEST actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_LENDINGREQUEST actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_LENDINGREQUEST actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_LENDINGREQUEST actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_LENDINGREQUEST actions', async () => {
      const expectedActions = [
        {

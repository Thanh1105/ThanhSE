...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './investment-request.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_INVESTMENTREQUEST_LIST actions', async () => {
    ...
    it('dispatches FETCH_INVESTMENTREQUEST actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_INVESTMENTREQUEST actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_INVESTMENTREQUEST actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_INVESTMENTREQUEST actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_INVESTMENTREQUEST actions', async () => {
      const expectedActions = [
        {

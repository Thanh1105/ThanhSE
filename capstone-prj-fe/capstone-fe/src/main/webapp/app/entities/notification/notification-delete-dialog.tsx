...
export const NotificationDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="capstoneFeApp.notification.delete.question">
        <Translate contentKey="capstoneFeApp.notification.delete.question" interpolate={{ id: notificationEntity.id }}>

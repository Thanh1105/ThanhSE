...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BALANCEACCOUNT_LIST actions', async () => {
    ...
    it('dispatches FETCH_BALANCEACCOUNT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_BALANCEACCOUNT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_BALANCEACCOUNT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_BALANCEACCOUNT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_BALANCEACCOUNT actions', async () => {
      const expectedActions = [
        {

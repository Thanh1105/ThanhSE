...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_INDENTIFICATION_LIST actions', async () => {
    ...
    it('dispatches FETCH_INDENTIFICATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_INDENTIFICATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_INDENTIFICATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_INDENTIFICATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_INDENTIFICATION actions', async () => {
      const expectedActions = [
        {

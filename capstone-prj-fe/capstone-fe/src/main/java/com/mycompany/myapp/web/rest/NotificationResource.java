    ...
    public ResponseEntity<Notification> partialUpdateNotification(
        ...
        Optional<Notification> result = notificationRepository
            ...
            .map(existingNotification -> {
                if (notification.getTypeNoti() != null) {
                    existingNotification.setTypeNoti(notification.getTypeNoti());
                }
                if (notification.getTypeAccount() != null) {
                    existingNotification.setTypeAccount(notification.getTypeAccount());
                }
                if (notification.getMessage() != null) {
                    existingNotification.setMessage(notification.getMessage());
                }
                if (notification.getHasRead() != null) {
                    existingNotification.setHasRead(notification.getHasRead());
                }

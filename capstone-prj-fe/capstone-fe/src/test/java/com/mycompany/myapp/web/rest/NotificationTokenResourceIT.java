...
class NotificationTokenResourceIT {
    ...
    void createNotificationToken() throws Exception {
        ...
        restNotificationTokenMockMvc
            .perform(
                post(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(notificationToken))
            )
    ...
    void putNewNotificationToken() throws Exception {
        ...
        restNotificationTokenMockMvc
            .perform(
                put(ENTITY_API_URL_ID, updatedNotificationToken.getId())
                    .contentType(MediaType.APPLICATION_JSON)
                    .content(TestUtil.convertObjectToJsonBytes(updatedNotificationToken))
            )
            .andExpect(status().isOk());
    ...
    void putNonExistingNotificationToken() throws Exception {
        ...
        restNotificationTokenMockMvc
            .perform(
                put(ENTITY_API_URL_ID, notificationToken.getId())
                    .contentType(MediaType.APPLICATION_JSON)
                    .content(TestUtil.convertObjectToJsonBytes(notificationToken))
            )
            .andExpect(status().isBadRequest());
    ...
    void putWithMissingIdPathParamNotificationToken() throws Exception {
        ...
        restNotificationTokenMockMvc
            .perform(
                put(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(notificationToken))
            )
    ...
    void patchNonExistingNotificationToken() throws Exception {
        ...
        restNotificationTokenMockMvc
            .perform(
                patch(ENTITY_API_URL_ID, notificationToken.getId())
                    .contentType("application/merge-patch+json")
                    .content(TestUtil.convertObjectToJsonBytes(notificationToken))
            )
            .andExpect(status().isBadRequest());
